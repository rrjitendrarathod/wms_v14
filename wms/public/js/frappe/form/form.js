...
import '../../../../../../frappe/frappe/public/js/frappe/form/form_tour';
import { UndoManager } from "../../../../../../frappe/frappe/public/js/frappe/form/undo_manager";
...
frappe.ui.form.Form = class FrappeForm {
	...
	refresh(docname) {
		...
		if (this.docname) {
			...
			// read only (workflow)
			// comment due to requirement
			// this.read_only = frappe.workflow.is_read_only(this.doctype, this.docname);
			// if (this.read_only) {
			// 	this.set_read_only(true);
			// 	frappe.show_alert(__("This form is not editable due to a Workflow11."));
			// }
